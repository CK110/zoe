...
export class ModalFromLeftEnter extends PageTransition {
  public init() {
    ...
    const headerWrapper = new Animation(this.plt, ele.querySelector('ion-header.header'));
    headerWrapper.beforeStyles({ 'width': '80%' });
    const contentWrapper = new Animation(this.plt, ele.querySelector('ion-content.content'));
    contentWrapper.beforeStyles({ 'width': '80%' });
    const footerWrapper = new Animation(this.plt, ele.querySelector('ion-footer.footer'));
    footerWrapper.beforeStyles({ 'width': '80%' });
    this
